...
def test_it_region_detector_lazy_file_hardest_example():
    with LazyFileMapNavigator(os.path.join(os.getcwd(), 'region_labeling', 'test', 'test_data', 'map_1000x1000.txt')) as map_navigator:
        region_detector = RegionDetector(map_navigator)
